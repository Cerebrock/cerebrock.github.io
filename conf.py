...
BLOG_AUTHOR = "Matías Grinberg"  # (translatable)
BLOG_TITLE = "Musical Neuron"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://cerebrock.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://cerebrock.github.io/"
BLOG_EMAIL = "mtsgrinberg@gmail.com"
BLOG_DESCRIPTION = "Entropy2song"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "musicalneuron"
...
DEFAULT_LANG: (
    ...
    ('https://www.linkedin.com/in/matias-grinberg', 'About me', 'fa fa-user'),
    ('https://twitter.com/Mati_G_', 'My Twitter', 'fab fa-twitter'),
    ('https://github.com/cerebrock', 'My Github', 'fab fa-github'),
)
}
